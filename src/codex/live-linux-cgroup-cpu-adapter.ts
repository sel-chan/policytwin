...
export function createPrivateLiveLinuxCgroupCpuDedicatedLifecycleContract(
  ...
  return Object.freeze({
    ...
    startBarrierProtocolImplemented: true as const,
    startBarrierHostOwnedReceiptSlotsImplemented: true as const,
    startBarrierReceiptCommitBindingImplemented: true as const,
    startBarrierConcurrentReleaseGuardImplemented: true as const,
    nonPrivilegedLifecycleHarnessImplemented: true as const,
    nativeHelperBoundaryPrepared: true as const,
    nativeHelperBuildVerified: false as const,
    nativeHelperRuntimeVerified: false as const,
