...
test("architecture source is self-contained and preserves the truthful live boundary", async () => {
  ...
  for (const required of [
    ...
    "Local challenge: 2 files, 7/7 tests, 41/41 cases, zero drift, APPROVE.",
    "Challenge evidence is local; production verify:live remains gated.",
    "Reference-expectation differential",
    "16 before; zero after local repair.*",
