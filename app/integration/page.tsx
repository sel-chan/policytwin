...
export default function IntegrationPage() {
  ...
  return <WorkspaceShell active="integration" eyebrow="Reference comparison / seeded fixture" title="Integration / Drift" summary="Recorded reference-policy expectations and TypeScript fixture behavior are compared case by case before repair." actions={<StatusPill tone="bad">{drift.summary.drifts} drifts</StatusPill>}>
    <section className="drift-hero panel"><div><span className="kicker">Run 2026-07-14 · REFERENCE_EXPECTATION_NOT_OPA</span><h2>Three seeded bugs, sixteen counterexamples</h2><p>This comparison uses the accepted corpus expectations, not OPA results. The fixture fails exact boundaries and lets a promotional approval bypass final-sale precedence.</p></div><div className="donut" aria-label={`${drift.summary.drifts} drift, ${drift.summary.matches} match`}><strong>{drift.summary.drifts}</strong><span>drift</span></div></section>
