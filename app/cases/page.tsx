...
export default function CasesPage() {
  ...
  return <WorkspaceShell active="cases" eyebrow="Policy test corpus / OPA 1.18.2" title="Case Lab" summary="OPA evaluates accepted cases; a separate reference evaluator measures mutation strength." actions={<StatusPill tone="ok">OPA 41 / 41</StatusPill>}>
    <section className="metric-strip"><div><span>Golden</span><strong>{verification.golden.passed}/{verification.golden.total}</strong><small>Authoritative</small></div><div><span>Generated</span><strong>{verification.generated.passed}/{verification.generated.total}</strong><small>Traceable cases</small></div><div><span>Mutation</span><strong>{(verification.mutation.killRate * 100).toFixed(1)}%</strong><small>Reference evaluator</small><small>{verification.mutation.killed}/{verification.mutation.total} killed · not OPA</small></div><div><span>Engine</span><strong>OPA</strong><small>v{opa.opaVersion}</small></div></section>
