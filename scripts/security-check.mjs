...
const ALLOWED_CHILD_PROCESS_FILES = new Set([
  ...
  "scripts/challenge-submission-check.mjs",
  ...
  "scripts/render-challenge-video.mjs",
  ...
  "src/codex/docker-command-runner.ts",
  "src/codex/linux-cgroup-helper-client.ts",
  "src/opa/runner.ts",
