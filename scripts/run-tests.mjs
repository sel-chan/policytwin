...
const suites = {
  unit: [
    ...
    "tests/unit/verifier-exchange-contract.test.mjs",
    "tests/unit/verifier-exchange-authority.test.mjs",
    "tests/unit/repair-verifier-review-bridge.test.mjs",
    ...
    "tests/unit/submission-draft-check.test.mjs",
    "tests/unit/submission-media-validation.test.mjs",
    "tests/unit/submission-claim-validation.test.mjs",
    "tests/unit/submission-package-check.test.mjs",
